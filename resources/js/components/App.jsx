...
const App = () => {
  ...
  const authHandler = async (event, url, signIn = false) => {
    ...
    .then(data => {
        if (!data.hasOwnProperty('errors')) {
          ...
          localStorage.setItem('belivenotes_user', data.data.user);
          setUserLogged(true);
          if (signIn) {
            setShowSignIn(false);
          } else {
  ...
  const logoutHandler = async event  => {
    ...
    try {
      ...
      localStorage.removeItem('belivenotes_user');
      setUserLogged(false);
      setNotes([]);
      ...
      <header className="px-3 bg-dark">
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
          <div className="container-fluid">
            <a className="navbar-brand" href="#"><FontAwesomeIcon className="me-2" icon={faNoteSticky}/>BeliveNotes</a>
            ...
            <div id="auth-actions" className="ms-auto">
              <ul className="navbar-nav">
                    ...
                    <>
                      ...
                      <FontAwesomeIcon className="me-2" icon={faUser} /> {localStorage.getItem('belivenotes_user')}
                      </li>
